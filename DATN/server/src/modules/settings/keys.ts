...
export const SETTING_DEFS: SettingDefinition[] = [
  { key: 'siteName', value: 'NT Thành Long', type: SettingType.TEXT, label: 'Tên website' },
  ...
  { key: 'email', value: 'lienhe@noithatthanhlong.vn', type: SettingType.TEXT, label: 'Email liên hệ' },
  {
    key: 'address',
    value: 'Quận 7, TP.HCM',
